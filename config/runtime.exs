...
#
#     PHX_SERVER=true bin/puppies_updater start
#
...
if config_env() == :prod do
  ...
  config :puppies_updater, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :puppies_updater, PuppiesUpdater.Mailer,
